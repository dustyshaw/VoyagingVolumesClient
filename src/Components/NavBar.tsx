      ...
      <Link className="react-link" to="/">
        <div className="d-flex flex-row">
          <img
            width={60}
            height={60}
            src="https://png.pngtree.com/png-vector/20230131/ourmid/pngtree-beautiful-compass-icon-vector-illustration-png-image_6580312.png"
            className="img"
          />
          <p className="navbar-brand lh-1 pt-2">
            Voyaging
            <br />
            Volumes
          </p>
